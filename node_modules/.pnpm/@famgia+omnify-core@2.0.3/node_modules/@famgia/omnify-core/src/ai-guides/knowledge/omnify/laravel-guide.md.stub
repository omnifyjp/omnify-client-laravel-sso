...
### Migrations
Located in `{{LARAVEL_ROOT}}database/migrations/omnify/`
...
- `{{LARAVEL_BASE}}/Models/OmnifyBase/*BaseModel.php` - Auto-generated, DO NOT EDIT
- `{{LARAVEL_BASE}}/Models/*.php` - User models, extend base models, safe to customize

### Factories
Located in `{{LARAVEL_ROOT}}database/factories/`
