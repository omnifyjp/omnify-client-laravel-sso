...
trait AssignsRoles
{
     ...
     */
    protected function assignRoleToUser(User $user, Role $role, ?string $orgId = null, ?string $branchId = null): void
    {
     ...
     */
    protected function removeUserRolesInScope(User $user, ?string $orgId = null, ?string $branchId = null): int
    {
