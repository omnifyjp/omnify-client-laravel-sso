...
use Omnify\SsoClient\Http\Requests\OmnifyBase\PermissionUpdateRequestBase;
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'group', type: 'string', maxLength: 50),
    ]
)]
class PermissionUpdateRequest extends PermissionUpdateRequestBase
{
    /**
