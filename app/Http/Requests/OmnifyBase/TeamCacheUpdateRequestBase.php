 ...
 *
 * This file is AUTO-GENERATED by Omnify from schema: TeamCache
...
abstract class TeamCacheUpdateRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'console_team_id' => ['sometimes', Rule::unique('team_caches')->ignore($this->route('team_cache'))],
