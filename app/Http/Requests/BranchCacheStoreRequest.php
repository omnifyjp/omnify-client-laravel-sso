...
use Omnify\SsoClient\Http\Requests\OmnifyBase\BranchCacheStoreRequestBase;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'BranchCacheStoreRequest',
...
class BranchCacheStoreRequest extends BranchCacheStoreRequestBase
{
    /**
