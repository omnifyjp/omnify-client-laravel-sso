...
use Omnify\SsoClient\Http\Requests\OmnifyBase\TeamCacheUpdateRequestBase;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'TeamCacheUpdateRequest',
    properties: [
...
class TeamCacheUpdateRequest extends TeamCacheUpdateRequestBase
{
    /**
