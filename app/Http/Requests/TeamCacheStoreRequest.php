...
use Omnify\SsoClient\Http\Requests\OmnifyBase\TeamCacheStoreRequestBase;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'TeamCacheStoreRequest',
...
class TeamCacheStoreRequest extends TeamCacheStoreRequestBase
{
    /**
