...
use Omnify\SsoClient\Http\Requests\OmnifyBase\RolePermissionStoreRequestBase;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'RolePermissionStoreRequest',
...
class RolePermissionStoreRequest extends RolePermissionStoreRequestBase
{
    /**
