...
class TeamCache extends TeamCacheBaseModel
{
     ...
     */
    protected static function newFactory(): \Omnify\SsoClient\Database\Factories\TeamCacheFactory
    {
        return \Omnify\SsoClient\Database\Factories\TeamCacheFactory::new();
    }
    ...
    public function permissions(): \Illuminate\Database\Eloquent\Relations\BelongsToMany
    {
        return $this->belongsToMany(
            ...
            'console_team_id',  // Local key on team_caches
